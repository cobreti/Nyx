...
{
	return new NyxNetLinux::CSSLTcpIpSocket_Impl();
}
 ...
 *
 */
NyxNetLinux::CSSLTcpIpSocket_Impl::CSSLTcpIpSocket_Impl() :
m_ctx(NULL),
m_ssl(NULL),
m_bio(NULL),
m_bSSLOwner(false)
 ...
 *
 */
NyxNetLinux::CSSLTcpIpSocket_Impl::CSSLTcpIpSocket_Impl( NyxNet::CTcpIpSocketRef refSocket ) :
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Listen( const Nyx::UInt32& MaxPendingConnections )
{
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Bind( const NyxNet::TcpIpPort& Port )
{
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Accept( NyxNet::CTcpIpSocketRef& NewSocket )
{
...
//        }
        ...
        NyxNetLinux::CSSLTcpIpSocket_Impl*    pSSLSocket = new NyxNetLinux::CSSLTcpIpSocket_Impl(socket);
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Connect()
{
 ...
 *
 */
void NyxNetLinux::CSSLTcpIpSocket_Impl::Disconnect()
{
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Write(	const void* pBuffer, const Nyx::NyxSize& DataSize, Nyx::NyxSize& WrittenSize )
{
    WrittenSize = 0;
...
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Read( void* pBuffer, const Nyx::NyxSize& DataSize, Nyx::NyxSize& ReadSize )
{
    ReadSize = 0;
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Create( const char* szIp, const NyxNet::TcpIpPort& Port )
{
    return Nyx::kNyxRes_Failure;
}
 ...
 *
 */
void NyxNetLinux::CSSLTcpIpSocket_Impl::SetListener( NyxNet::ISocketListener* pListener )
{
 ...
 *
 */
bool NyxNetLinux::CSSLTcpIpSocket_Impl::Valid() const
{
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CSSLTcpIpSocket_Impl::Renew()
{
 ...
 *
 */
void NyxNetLinux::CSSLTcpIpSocket_Impl::SetPrivKeyFile( const Nyx::CAString& privKeyFile )
{
 ...
 *
 */
void NyxNetLinux::CSSLTcpIpSocket_Impl::SetPublicKeyFile( const Nyx::CAString& publicKeyFile )
{
 ...
 *
 */
void NyxNetLinux::CSSLTcpIpSocket_Impl::SetDhKeyFile( const Nyx::CAString& dhKeyFile )
{
 ...
 *
 */
void NyxNetLinux::CSSLTcpIpSocket_Impl::InitSSL()
{
    int res = 0;
