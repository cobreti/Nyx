...
{
	return new NyxNetLinux::CPipeServer_Impl();
}
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CPipeServer_Impl::Create(	const char* szPipeName,
													...
													NyxNet::IConnectionHandler* pConnHandler )
{
	...
	m_refConnection = new NyxNetLinux::CPipeClientConn(m_refSocket);
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CPipeServer_Impl::Start()
{
	...
	{
		m_bTerminate = false;
		m_refThread->Start(	new Nyx::CThreadDelegate<NyxNetLinux::CPipeServer_Impl>(this,
			&NyxNetLinux::CPipeServer_Impl::Thread_RunningLoop,
			&NyxNetLinux::CPipeServer_Impl::Thread_Stop) );
	}
 ...
 *
 */
Nyx::NyxResult NyxNetLinux::CPipeServer_Impl::Stop()
{
	m_refThread->Stop();
 ...
 *
 */
bool NyxNetLinux::CPipeServer_Impl::IsRunning() const
{
 ...
 *
 */
void NyxNetLinux::CPipeServer_Impl::Thread_RunningLoop()
{
 ...
 *
 */
void NyxNetLinux::CPipeServer_Impl::Thread_Stop()
{
	m_bTerminate = true;
 ...
 *
 */
/*void NyxNetLinux::CPipeServer_Impl::Connect()
{
	Nyx::NyxResult		res;
 ...
 *
 */
/*void NyxNetLinux::CPipeServer_Impl::Disconnect()
{
	close(m_PipeId);
	m_PipeId = 0;
 ...
 *
 */
/*void NyxNetLinux::CPipeServer_Impl::ReleaseBuffer()
{
	if ( NULL != m_pBuffer )
	{
		free(m_pBuffer);
 ...
 *
 */
/*Nyx::NyxResult NyxNetLinux::CPipeServer_Impl::AllocBuffer(const Nyx::NyxSize& BufferSize)
{
	Nyx::NyxResult		res = Nyx::kNyxRes_Failure;
 ...
 *
 */
/*Nyx::NyxResult NyxNetLinux::CPipeServer_Impl::CreatePipe()
{
