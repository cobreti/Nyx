...
{
	return new NyxOSX::CStringFormater_Impl(BufferSize);
}
 ...
 *
 */
NyxOSX::CStringFormater_Impl::CStringFormater_Impl(size_t BufferSize) :
m_wszBuffer(NULL),
m_BufferSize(0)
{
 ...
 *
 */
NyxOSX::CStringFormater_Impl::~CStringFormater_Impl()
{
	if ( NULL != m_wszBuffer )
	{
		free(m_wszBuffer);
 ...
 *
 */
Nyx::NyxResult NyxOSX::CStringFormater_Impl::Format( const wchar_t* wszFormat, ... )
{
