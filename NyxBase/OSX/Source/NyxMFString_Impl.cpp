...
//		m_Flags.fMutable = 1;
	...
	void CMFString::Append( const char* szValue )
	{
		...
		strlcat(m_Buffer.pChar, szValue, BufferLen());
	}
	...
	void CMFString::Append( const wchar_t* wszValue )
	{
		...
		wcslcat(m_Buffer.pWChar, wszValue, BufferLen());
	}
	...
	void CMFString::Add( const char* szValue, size_t sizeInBytes, CMFString& resultStr ) const
	{
		...
		strlcat( resultStr.m_Buffer.pChar, szValue, resultStr.BufferLen() );
	}
	...
	void CMFString::Add( const wchar_t* wszValue, size_t sizeInBytes, CMFString& resultStr ) const
	{
		...
		resultStr.Resize( sizeInBytes + m_BufferSize );
		wcslcpy( resultStr.m_Buffer.pWChar, m_Buffer.pConstWChar, resultStr.BufferLen() );
		wcslcat( resultStr.m_Buffer.pWChar, wszValue, resultStr.BufferLen() );
	}
