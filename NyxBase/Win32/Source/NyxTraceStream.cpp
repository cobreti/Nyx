...
public:
	...
	//virtual Nyx::CTraceFeed::ECharFormat CharFormat() const { return Nyx::CTraceFeed::eCF_WideChar; }
...
public:
	...
	//virtual Nyx::CTraceFeed::ECharFormat CharFormat() const { return Nyx::CTraceFeed::eCF_Ansi; }
